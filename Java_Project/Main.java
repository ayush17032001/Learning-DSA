...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        album.addSong("Phir kabhi", "C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-1 (MS Dhoni)\\Phir kabhi.mp3");
        album.addSong("Parwah nahin", "C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-1 (MS Dhoni)\\Parwah nahin.mp3");
        album.addSong("Kaun tujhe","C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-1 (MS Dhoni)\\Kaun tujhe.mp3");

        albums.add(album);

        album=new Album_name("Album-2", "Ae dil hai mushkil");  //album2 is the second of albums in the ArrayList - Index 1
        album.addSong("Buleya", "C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-2 (Ae dil hai mushkil)\\Buleya.mp3");
        album.addSong("Channa mereya","C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-2 (Ae dil hai mushkil)\\Channa Mereya.mp3" );
        album.addSong("title track","C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-2 (Ae dil hai mushkil)\\Title track.mp3" );

        albums.add(album);

        album=new Album_name("Album-3", "Aashiqui2");  //album3 is the third of albums in the ArrayList - Index 2
        album.addSong("Tum hi ho", "C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-3 (Ashiqui 2)\\Tum Hi Ho.mp3");
        album.addSong("Chahun main ya na", "C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-3 (Ashiqui 2)\\Chahun Main Ya Naa.mp3");
        album.addSong("Sunn raha hai","C:\\Users\\ahdt1\\Desktop\\dsa.java\\src\\Java_Project\\Album-3 (Ashiqui 2)\\Sunn Raha Hai.mp3");
